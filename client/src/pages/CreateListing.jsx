...
export default function CreateListing() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      if(parseInt(formData.regularPrice) <= parseInt(formData.discountPrice)) return setSubmitError('Discounted price must be less than the price!') 
            ...
            <div className="flex flex-col flex-1 gap-4">
                ...
                <button
                  className="p-3 bg-green-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-70" disabled={uploading || submitLoading} >
                    { submitLoading ? 'Creating...' : 'Create a Listing' }
                </button>
