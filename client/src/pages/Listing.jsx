        ...
        <div className="flex flex-col">
            <div className="flex flex-col sm:flex-row gap-4 m-2"> 
              ...
              <div className="flex flex-col flex-1 gap-4">
                ...
                <div className="px-2 bg-slate-500 w-fit">{listing.type === 'rent' ? 'For Rent' : 'For Sale'}</div>
                ...
                <table className="min-w-full bg-white border border-gray-300">
                  <tbody>
                    <tr>
                      ...
                      <td className={`py-2 px-4 border-b ${listing.offer ? 'line-through' : ''}`}>${listing.regularPrice}{listing.type === 'rent' ? <span> / month</span> : ''}</td>
                    </tr>
                    { !listing.offer ? null :
                      <tr>
                        <td className="py-2 px-4 border-b border-r">Discounted Price</td>
                        <td className="py-2 px-4 border-b">${listing.discountPrice}{listing.type === 'rent' ? <span> / month</span> : ''}</td>
                      </tr>
                    }
                    <tr>
            ...
            <div className="p-2 mt-2 border border-slate-300">
